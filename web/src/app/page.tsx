...
// Import Hero component with dynamic import and disable SSR
...
export default function Home() {
  ...
  const handleGenerateCompleteManga = async () => {
    ...
    try {
      ...
      // Create form data safely without using document
  ...
  return (
    <main className="min-h-screen p-8">
      <div className="flex flex-col items-center max-w-6xl mx-auto">
        {/* Hero component is already dynamically imported with ssr: false */}
        <Hero />
